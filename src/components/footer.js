...
import { useTitle } from '@/components/player/components/title';  //website title import here.
        ...
        <div>
            <footer className="bg-[#151518] mt-10">
                    ...
                    <div className="lg:flex lg:justify-between">
                        <div className="mb-6 lg:mb-0">
                            <Link href="/" className="flex items-center w-fit">
                                <p className={`reveraki self-center text-3xl font-medium whitespace-nowrap dark:text-white`}>REVERAKI</p>
                            </Link>
                            <p className="font-karla lg:text-[0.8rem] text-[0.7rem] text-[#ffffffb2] lg:w-[520px]">
                                ...
                                <ul className="font-semibold flex flex-col gap-2 lg:text-[0.85rem] text-[0.7rem] text-[#ffffffb2]">
                                    ...
                                    <li>
                                        <Link href="https://ko-fi.com/" target='_blank' className="hover:text-white !font-semibold !text-[0.8rem]">Donate</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="mx-auto w-full lg:max-w-[83%] lg:flex lg:items-center lg:justify-between lg:text-[0.8rem] text-[0.7rem] text-[#ffffffb2] py-3">
                    <span className="sm:text-center ms-5 lg:ms-0">© {year} <Link href="/" className="hover:text-white">REVERAKI™</Link> | Made by <span className="font-bold" >codeblitz97</span>
                    </span>
                    <div className="flex mt-4 lg:justify-center lg:mt-0">
                        <Link href="https://github.com/codeblitz97/reveraki" target="_blank" className=" hover:text-gray-900 dark:hover:text-white ms-5 lg:ms-0">
                        ...
                        <Link href="https://discord.gg/AKMfgTnd" target="_blank" className=" hover:text-gray-900 dark:hover:text-white ms-5">
