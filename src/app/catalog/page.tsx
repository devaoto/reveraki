  ...
  React.useEffect(() => {
    const fetchSearchResult = async () => {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_DOMAIN}/api/v2/advancedSearch?${queryParams}`,
      );
    ...
    <div className="ml-5">
      ...
      <div className="flex flex-col gap-4 lg:flex-row">
        <div>
          ...
          <div className="min-w-full max-w-full rounded-lg bg-[#12010e] p-2 shadow-md md:min-w-full md:max-w-full lg:min-w-[300px] lg:max-w-[300px]">
            <RadioGroup
          ...
          <div className="mt-2 min-w-full max-w-full rounded-lg bg-[#12010e] p-2 shadow-md md:min-w-full md:max-w-full lg:min-w-[300px] lg:max-w-[300px]">
            <RadioGroup
